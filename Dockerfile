...
COPY download.sh .
RUN mkdir -p /home/gitpod/ddev_images
RUN bash download.sh /home/gitpod/ddev_images/db drud/ddev-dbserver-mariadb-10.3:v1.19.2
RUN bash download.sh /home/gitpod/ddev_images/web drud/ddev-webserver:v1.19.2
RUN bash download.sh /home/gitpod/ddev_images/router drud/ddev-router:v1.19.0
RUN bash download.sh /home/gitpod/ddev_images/ssh drud/ddev-ssh-agent:v1.19.0
